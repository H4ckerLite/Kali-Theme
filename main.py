...
def menu():
    ...
    blue()
    time.sleep(1)
    print("1 -> Install Necessary Requirements")
    time.sleep(1)
    print("\n2 -> Install Bspwm")
    time.sleep(1)
    print("\n3 -> Install Polybar, Picom, Rofi...")
    time.sleep(1)
...
def req():
    ...
    time.sleep(2)
    print("[+] Requirements installed correctly")
...
if __name__ == '__main__':
    ...
    if id == 0:
        red()
        print()
        print("[!] You don't have to be root to run the tool")
        print()
    else:
        menu()
